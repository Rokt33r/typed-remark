...
const BOOLEAN_VALUE = 0x8
const NUMERIC_VALUE = 0x10
const POSITIVE_NUMERIC_VALUE = 0x20 | 0x10
const OVERLOADED_BOOLEAN_VALUE = 0x40
const SPACE_SEPARATED = 0x80
...
for (property in propertyConfig) {
  aName = property.toLowerCase()
  aName = propertyToAttributeMapping[aName] || aName
